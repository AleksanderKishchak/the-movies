...
export function* getPopularMovies() {
  ...
  yield put({ type: 'GET_MOVIES', data });
}
...
export function* watchGettingMovies() {
  yield takeEvery('GET_POPULAR', getPopularMovies);
  yield takeEvery('GET_BY_NAME', getMoviesByName);
  yield takeEvery('GET_BY_GENRE', getMoviesByGenre);
}
